...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    custName: Schema.Attribute.String;
    ...
    status_O: Schema.Attribute.Enumeration<
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isWeeklyDeal: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    ...
    product_rating: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    product_volume: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    reviews: Schema.Attribute.Relation<'oneToMany', 'api::review.review'>;
    sizes: Schema.Attribute.Component<'product.size-option', true>;
    small_desc: Schema.Attribute.Text;
    sub_categories: Schema.Attribute.Relation<
      'manyToMany',
      'api::sub-category.sub-category'
    >;
